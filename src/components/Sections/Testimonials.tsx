    ...
    <div
      ...
      {image ? (
        <div className="relative h-14 w-14 shrink-0 sm:h-16 sm:w-16">
          <QuoteIcon className="absolute -left-2 -top-2 h-3 w-3 stroke-black text-white" />
      ...
      <div className="flex flex-col gap-y-4">
        <p className="prose prose-sm font-small italic text-white sm:prose-base">{text}</p>
        <p className="text-xs italic text-white sm:text-sm md:text-base lg:text-md">-- {name}</p>
      </div>
    </div>
  ),
);
